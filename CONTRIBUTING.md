...
Thanks for considering a contribution to pyrig-codecov! Following
...
opening a new issue, search [existing issues](https://github.com/Winipedia/pyrig-codecov/issues)
to avoid duplicates.
...
- All checks in [CI](https://github.com/Winipedia/pyrig-codecov/actions/workflows/health_check.yml) must pass before merge.
